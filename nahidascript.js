...
var BGM = new Audio("./music/bgm.mp3"); //BGM
...
const LANGUAGES = {
    ...
    "cn": {
        ...
        texts: {
            "page-title": "Portal Nahida &nbsp;",
            "doc-title": "NHD ID~",
            "page-descriptions": "Aku adalah Nahida，Seorang <del>Gadis Imut</del> Archon Dendro yang memimpin sebuah negara bernama sumeru！",
            "counter-descriptions": ["Aku Berbagi Pengetahuan", "Mari Bersenang-senang~"],
            "counter-unit": ["啦！"],
            "counter-button": ["Heii~", "Teri-Teri~"],
    ...
    "en": {
        ...
        texts: {
            ...
            "counter-descriptions": ["I share my knowledge", "let's be have fun~"],
            "counter-unit": "times",
            "counter-button": ["Hey~!", "Teri-Teri~!"],
...
function refreshLanguageSelector(selectedLanguage) {
    switch (selectedLanguage) {
        case "cn":
            document.getElementById("lan1").innerHTML = "🌏Indonesia";
...
function refreshModeSelector(selectedLanguage) {
    switch (selectedLanguage) {
        case "cn":
            document.getElementById("mode1").innerHTML = "Mode Normal";
            document.getElementById("mode2").innerHTML = "Hanya Musik";
            // document.getElementById("mode3").innerHTML = "隐藏彩蛋";
            break;
        case "ja":
            document.getElementById("mode1").innerHTML = "デフォルトモード";
            document.getElementById("mode2").innerHTML = "ジャストミュージック";
            // document.getElementById("mode3").innerHTML = "ひみつ";
            break;
        case "en":
            document.getElementById("mode1").innerHTML = "Default Mode";
            document.getElementById("mode2").innerHTML = "Just Music";
...
document.addEventListener("DOMContentLoaded", function () {
    $.ajax({
        url: 'http://jojo.tirtagt.xyz/getNahidaGlobalcounts',
        method: 'GET',
        dataType: 'json',
        headers: {
            'ajax-requests': 'true'
